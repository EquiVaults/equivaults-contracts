...
contract EquiVaultTest is Test {
    ...
    function setUp() public {
        ...
        vault = new EquiVault(usdc, registry, manager, assets(), weights(), 1_000, 100);
    }
    ...
    function testConstructorRejectsInvalidParameters() public {
        ...
        new EquiVault(usdc, registry, manager, six, sixW, 1_000, 100);
        ...
        new EquiVault(usdc, registry, manager, one, new uint16[](0), 1_000, 100);
        ...
        new EquiVault(usdc, registry, manager, two, lowW, 1_000, 100);
        ...
        new EquiVault(usdc, registry, manager, one, partialW, 1_000, 100);
        ...
        new EquiVault(usdc, registry, manager, dupAssets, dupW, 1_000, 100);
        ...
        new EquiVault(usdc, registry, manager, withUsdc, dupW, 1_000, 100);
        ...
        new EquiVault(usdc, registry, manager, unknown, fullW, 1_000, 100);
    }
    ...
    function testDualOracleFailurePausesOnlyAffectedVault() public {
        ...
        bW[0] = 10_000;
        EquiVault vault2 = new EquiVault(usdc, registry, manager, bOnly, bW, 1_000, 100);
